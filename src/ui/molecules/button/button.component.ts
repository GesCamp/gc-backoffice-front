...
type ButtonProps = {
  ...
  size: 'small' | 'medium' | 'large' | 'usmall';
...
export class ButtonComponent {
  ...
  @ContentChild('buttonText', { static: false }) textContent?: ElementRef;
  ...
  hasText(): boolean {
    return !!this.textContent?.nativeElement?.textContent?.trim();
  }
